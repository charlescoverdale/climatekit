...
ET-SCI heatwave family index. Reports the mean magnitude of daily Tmax
across all heatwave days in the year. `mode = "excess"` (default) gives
the mean of (Tmax - threshold), matching the ET-SCI / climpact
convention. `mode = "absolute"` gives the mean raw Tmax across heatwave
days, matching Perkins-Alexander (2013). Returns `NA` for years with no
heatwaves.
...
#> 26 1986-01-01        NA   hwm   °C
#> 27 1987-01-01 0.3841954   hwm   °C
#> 28 1988-01-01        NA   hwm   °C
#> 29 1989-01-01        NA   hwm   °C
#> 30 1990-01-01        NA   hwm   °C
#> 31 1991-01-01 0.3491542   hwm   °C
```
