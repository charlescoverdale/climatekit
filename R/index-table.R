...
.ck_index_table <- function() {
  rows <- list(
    ...
    c("spi", "ck_spi", NA_character_, "Standardised Precipitation Index", "drought", "water", "dimensionless", "drought", "mckee1993relationship", "precip,dates", "Standardised Precipitation Index", "McKee et al. 1993"),
    c("spei", "ck_spei", NA_character_, "Standardised Precipitation-Evapotranspiration Index", "drought", "water", "dimensionless", "drought", "vicente2010multiscalar", "precip,pet,dates", "Standardised Precipitation-Evapotranspiration Index", "Vicente-Serrano et al. 2010"),
